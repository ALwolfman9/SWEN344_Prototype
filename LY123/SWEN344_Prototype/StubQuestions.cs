...
namespace SWEN344_Prototype
{
	public class StubQuestions
	{
		...
		public StubQuestions()
		{
			...
			five.name = "How many letters are in 'Space'?";
			five.grade = 0;
			five.level = 1;
			five.subject = "Math";
			five.complete = false;
			...
			seven.name = "How many 4's are there? 44444";
			seven.grade = 0;
			seven.level = 1;
			seven.subject = "Math";
			...
			eight.name = "What number comes after 2?";
			eight.level = 1;
			eight.subject = "Math";
			...
			nine.name = "Count the words in this sentence.";
			nine.grade = 0;
			nine.level = 1;
			nine.subject = "Math";
			nine.complete = false;
