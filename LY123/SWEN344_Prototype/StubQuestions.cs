...
namespace SWEN344_Prototype
{
	public class StubQuestions
	{
		...
		public StubQuestions()
		{
			...
			four.name = "How Many Tallies are there? ||||";
			four.grade = 0;
			four.level = 1;
			four.subject = "Math";
			four.complete = false;
			...
			answer6d.correct = true;
			answers6.Insert(3, answer6d);
			six.answers = answers2;
			questions.Add(six);
